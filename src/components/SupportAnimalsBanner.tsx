...
export default function SupportAnimalsBanner({ message = 'Todos nuestros productos ayudan a los animalitos abandonados — Pre Fundación PATITAS en la calle. ¡Ayúdanos a ayudar!', images = DEFAULT_IMAGES, persistKey = 'supportAnimalsBanner:v1', onDonate }: Props) {
